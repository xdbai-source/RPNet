...
class VGG(nn.Module):
    def __init__(self):
        ...
        self.bam1 = CBAMBlock(channel=128,reduction=16,kernel_size=81)
        self.bam2 = CBAMBlock(channel=256,reduction=16,kernel_size=41)
        self.bam3 = CBAMBlock(channel=512,reduction=16,kernel_size=21)
        self.bam4 = CBAMBlock(channel=512,reduction=16,kernel_size=11)
