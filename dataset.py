...
class Dataset(data.Dataset):
    def __init__(self, data_path, dataset, is_train):
        ...
        if dataset == 'SHA':
            ...
            if is_train:
                dataset_img = os.path.join('train', 'images')
                dataset_label = os.path.join('train', 'new_data')
            else:
                dataset_img = os.path.join('test', 'images')
                dataset_label = os.path.join('test', 'new_data')
    ...
    def __getitem__(self, index):
        ...
        if self.is_train:
            ...
            return image, gt ,self.image_list[index], density
